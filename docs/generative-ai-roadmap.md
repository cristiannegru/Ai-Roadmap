...
- 📺 **Prompt Engineering Masterclass**: [Watch Video](https://www.youtube.com/watch?v=J50L7PxA1Qc)
...
- 📺 **LlamaIndex Tutorial for Beginners**: [Watch Video](https://www.youtube.com/watch?v=A7EpJzaqtNc)
...
- 📺 **Fine-Tuning LLMs Explained (LoRA/QLoRA)**: [Watch Video](https://www.youtube.com/watch?v=J50L7PxA1Qc)
- 📺 **Fine-Tuning LLM on Custom Dataset (PyTorch & Unsloth)**: [Watch Video](https://www.youtube.com/watch?v=J50L7PxA1Qc)
...
2. **Local Customer Support Chatbot (Ollama + LangChain + Streamlit)**
   - 📺 **Project Tutorial**: [Watch Video](https://www.youtube.com/watch?v=A7EpJzaqtNc)
3. **Custom Fine-Tuning of Llama 3 (Unsloth + HuggingFace)**
   - 📺 **Project Tutorial**: [Watch Video](https://www.youtube.com/watch?v=J50L7PxA1Qc)
